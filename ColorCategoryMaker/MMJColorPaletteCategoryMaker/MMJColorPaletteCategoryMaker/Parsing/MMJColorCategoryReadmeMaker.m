...
+ (NSString *)tableRowForImageSource:(NSString *)imageSource colorName:(NSString *)colorName colorCode:(NSString *)colorCode colorComponents:(NSDictionary *)colorComponents shortFormat:(BOOL)shortFormat
{
    ...
    NSString *longTR = [NSString stringWithFormat:TABLE_ROW, imageSource, colorName, colorCode, colorHex];
    NSString *shortTR = [NSString stringWithFormat:TABLE_ROW_SHORT, imageSource, colorCode, colorHex];
    
    return shortFormat ? shortTR : longTR;
}
...
+ (NSString *)tableStringFromColorsDictionary:(NSDictionary *)colorsDictionary categoryName:(NSString *)categoryName imageSize:(CGSize)imageSize gitHubPath:(NSString *)gitHubPath imagesDirectory:(NSString *)imagesDirectory shortFormat:(BOOL)shortFormat
{
   __block NSMutableString *tableString = [[NSMutableString alloc] init];
    ...
    [colorNames enumerateObjectsUsingBlock:^(id object, NSUInteger idx, BOOL *stop) {
        ...
        //make table row
        NSString *tableRow = [MMJColorCategoryReadmeMaker tableRowForImageSource:imgSrc colorName:colorMethodName colorCode:colorCode colorComponents:oneColorComponents shortFormat:shortFormat];
                                     ...
                                     shortFormat:(BOOL)shortFormat
{
    ...
    NSString *tableString = [MMJColorCategoryReadmeMaker tableStringFromColorsDictionary:colorsDictionary categoryName:colorCategoryName imageSize:imageSize gitHubPath:gitHubPath imagesDirectory:imagesDirectory shortFormat:shortFormat];
...
+ (NSString *)readmeContentsForColorCategoryName:(NSString *)colorCategoryName
                                ...
                                colorsDictionary:(NSDictionary *)colorsDictionary
                                 ...
                                 imagesDirectory:(NSString *)imagesDirectory
{
    return [MMJColorCategoryReadmeMaker readmeContentsForColorCategoryName:colorCategoryName colorCodesSource:colorCodesSource colorsDictionary:colorsDictionary imageSize:imageSize gitHubPath:gitHubPath imagesDirectory:imagesDirectory shortFormat:NO];
}
